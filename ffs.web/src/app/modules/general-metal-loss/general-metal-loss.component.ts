...
export class GeneralMetalLossComponent extends ModuleBase
  ...
  ngAfterViewInit(): void {
    ...
    this.moduleEvent.requestCalculateSubject.subscribe(() => {
      ...
      calculationParam.inspectionGridData = this.metalLossInput.inspectionGridData;

      this.moduleEvent.calculatingSubject.emit(null);

      this.http
        .post(
          `api/localmetalloss/calculation/level${
    ...
    this.designInput.form
      .get('autoCalculateMinRequireThickness')
      .setValue(true);
