...
export class HydrogenComponent extends ModuleBase
  ...
  rowModels: KV[] = [
    ...
    {
      key: 'DirectionCircumferential',
      value: 'Flaw Dimension in Circumferential Direction'
    },
    {
      key: 'DirectionLongitudinal',
      value: 'Flaw Dimension in Longitudinal Direction'
    },
    {
      key: 'InternalSurface',
      value: 'Minimum Measured Thickness to Internal Surface'
    },
    {
      key: 'ExternalSurface',
      value: 'Minimum Measured Thickness to External Surface'
    },
    {
      key: 'TotalOfBothSides',
      value: 'Minimum Measured Thickness; Total of Both Sides'
    },
    {
      key: 'SpacingToNearestHIC',
      value: 'Edge-To-Edge Spacing To Nearest HIC or Blister'
    },
    { key: 'WeldJoint', value: 'Spacing To Nearest Weld Joint' },
    {
      key: 'MajorStructuralDiscontinuity',
  ...
  ngAfterViewInit(): void {
    ...
    this.moduleEvent.requestCalculateSubject.subscribe(() => {
      ...
      this.http
        .post(
          `api/hydrogen/calculation/level${
