...
@Component({
  selector: 'app-creep-rupture',
  templateUrl: './creep-rupture.component.html',
  styleUrls: ['./creep-rupture.component.scss'],
  animations: [routerTransition()],
  host: { '[@routerTransition]': '' }
})


export class CreepRuptureComponent extends ModuleBase implements OnInit, AfterViewInit {
  name = 'Creep Rupture';
